> 内容来源于：[https://liaoxuefeng.com/books/java/io/index.html](https://liaoxuefeng.com/books/java/io/index.html)
...
例如，我们把`char[]`数组Hi你好这4个字符用Writer字符流写入文件，并且使用UTF-8编码，得到的最终文件内容是8个字节，英文字母H和i各占一个字节，中文字符你好各占3个字节：
