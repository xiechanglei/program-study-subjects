> 内容来源于：[https://liaoxuefeng.com/books/java/generics/extends/index.html](https://liaoxuefeng.com/books/java/generics/extends/index.html)
...
即返回值是`Number`或`Number`的子类，因此，可以安全赋值給`Number`类型的变量：
