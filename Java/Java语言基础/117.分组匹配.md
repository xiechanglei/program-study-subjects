> 内容来源于：[https://liaoxuefeng.com/books/java/reg-exp/group/index.html](https://liaoxuefeng.com/books/java/reg-exp/group/index.html)

我们前面讲到`String`和`Pattern`和`Matcher`类在Java正则表达式中的应用。
