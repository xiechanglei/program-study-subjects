> 内容来源于：[https://liaoxuefeng.com/books/java/collection/priority-queue/index.html](https://liaoxuefeng.com/books/java/collection/priority-queue/index.html)
...
因此，放入PriorityQueue的元素，必须实现`Comparable`接口，PriorityQueue会根据元素的排序顺序决定出队的优先级。
