> 内容来源于：[https://liaoxuefeng.com/books/java/security/hash/index.html](https://liaoxuefeng.com/books/java/security/hash/index.html)
...
SHA-1也是一种哈希算法，它的输出是160 bits，即20字节。SHA-1是由美国国家标准局开发的，SHA算法实际上是一个系列，包括SHA-0（已废弃）、SHA-1、SHA-256、SHA-512等。
...
MD5因为输出长度较短，短时间内破解是可能的，目前已不推荐使用。
