> 内容来源于：[https://liaoxuefeng.com/books/java/generics/reflection/index.html](https://liaoxuefeng.com/books/java/generics/reflection/index.html)
...
调用Class的`getSuperclass()`方法返回的Class类型是`Class<? super T>`：
