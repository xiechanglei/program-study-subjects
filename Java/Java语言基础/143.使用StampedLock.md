> 内容来源于：[https://liaoxuefeng.com/books/java/threading/synchronize/stamped-lock/index.html](https://liaoxuefeng.com/books/java/threading/synchronize/stamped-lock/index.html)
...
为进一步提升并发执行效率，Java 8引入了新的读写锁：`StampedLock`。
