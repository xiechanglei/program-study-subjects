> 内容来源于：[https://liaoxuefeng.com/books/java/threading/thread-local/index.html](https://liaoxuefeng.com/books/java/threading/thread-local/index.html)
...
最后对比一下局部变量、静态变量和`ThreadLocal`变量的区别：
