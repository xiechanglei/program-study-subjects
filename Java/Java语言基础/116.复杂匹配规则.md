> 内容来源于：[https://liaoxuefeng.com/books/java/reg-exp/complex-match/index.html](https://liaoxuefeng.com/books/java/reg-exp/complex-match/index.html)
...
上面的规则仍然不能匹配"learn Java"、"learn Go"这样的字符串。试修改正则，使之能匹配大写字母开头的"learn Java"、"learn Php"、"learn Go"这样的字符串。
