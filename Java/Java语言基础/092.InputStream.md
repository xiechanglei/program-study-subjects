> 内容来源于：[https://liaoxuefeng.com/books/java/io/input-stream/index.html](https://liaoxuefeng.com/books/java/io/input-stream/index.html)
...
public void readFile() throws IOException {
    ...
    for (;;) {
        int n = input.read(); // 反復调用read()方法，直到返回-1
        if (n == -1) {
            break;
        }
