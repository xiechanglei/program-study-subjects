> 内容来源于：[https://liaoxuefeng.com/books/java/threading/synchronize/dead-lock/index.html](https://liaoxuefeng.com/books/java/threading/synchronize/dead-lock/index.html)
...
这样一来，不管哪个线程先获取哪个锁，获取锁的顺序都是相同的，就不会发生死锁。
